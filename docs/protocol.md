        # Overlapmatrix: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/overlapmatrix.git

        ## Objective

        OverlapMatrix calculates and visualises study overlap in systematic review networks, quantifying the degree of evidence re-use across related meta-analyses.
        ...
        - Code: https://github.com/mahmood726-cyber/overlapmatrix.git
